...
import { trainingsScopeKey } from '../api/trainings'
      ...
      <div className="space-y-4">
        ...
        {!translation && state?.autoTranslating && (
          <p className="flex items-center gap-2.5 rounded-xl bg-steel-50 px-4 py-3 text-sm text-steel-700 ring-1 ring-steel-200 ring-inset">
            ...
            <span>
              Translating this training into Spanish now — it started when the module was
              published. This page updates itself when it lands.
            </span>
          </p>
        )}
          ...
          <div className="space-y-3">
            {state?.autoTranslationFailed && (
              <p className="flex items-start gap-2.5 rounded-xl bg-citron-50 px-4 py-3 text-sm text-citron-700 ring-1 ring-citron-200 ring-inset">
                ...
                <span>
                  The automatic translation for this training did not finish. Nothing was saved
                  and staff are unaffected — translate it here when you are ready.
                </span>
              </p>
            )}
            <div className="flex flex-wrap items-center justify-between gap-3">
              <p className="max-w-xl text-sm text-salt-600">
                Translates the published module into Spanish for review. Nothing reaches staff
          ...
          <>
            {translation.stale && (
              <p className="flex items-start gap-2.5 rounded-xl bg-citron-50 px-4 py-3 text-sm text-citron-700 ring-1 ring-citron-200 ring-inset">
                <ShieldAlert className="mt-0.5 size-4 shrink-0" aria-hidden />
                <span>
                  The published module has changed since this translation was made. Staff no
                  longer see it. Re-translate, review and approve again.
                </span>
              </p>
            )}
            {liveUnreviewed && (
              <p className="flex items-start gap-2.5 rounded-xl bg-citron-50 px-4 py-3 text-sm text-citron-700 ring-1 ring-citron-200 ring-inset">
                ...
                <span>
                  ...
                  publish translations automatically. Read every line; approving below records
                  your sign-off, and edits go live the moment you approve them.
                </span>
              </p>
            )}
                ...
                <div className="space-y-2">
                  ...
                  <ol className="space-y-2">
                    {training.blocks.map((block, index) => {
                      ...
                      const setBlock = (
                        patch: Partial<{ text: string; caption: string }>
                      ) =>
                        setDraft({
                          ...draft,
