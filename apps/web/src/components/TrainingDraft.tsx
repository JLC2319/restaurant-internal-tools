...
import { getDraftConfig, draftTrainingsFromMaterials } from '../api/drafts'
import { createTraining, trainingsScopeKey } from '../api/trainings'
...
import { TRAINING_DRAFTING_MESSAGES, WorkingOverlay } from './WorkingOverlay'
import {
  EmptyState,
  ErrorNote,
  Skeleton,
