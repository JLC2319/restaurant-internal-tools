...
export function approveTrainingTranslation(
  ...
  return apiRequest<TrainingTranslationView>(`/api/translations/trainings/${trainingId}/approve`, {
    method: 'POST',
    body: JSON.stringify({ locale }),
  });
}
...
export function rejectTrainingTranslation(
  ...
  return apiRequest<TrainingTranslationView>(`/api/translations/trainings/${trainingId}/reject`, {
    method: 'POST',
    body: JSON.stringify({ locale }),
  });
}
